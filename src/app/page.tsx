...
const products = [
  ...
  { id: 5, name: 'Confitura Bordeaux', price: 3000, category: 'mermeladas', image: '/confitura.jpg', desc: 'Edición especial' },
  ...
  { id: 10, name: 'Pimientos Agridulces', price: 2600, category: 'conservas', image: '/pimientos-agridulces.jpg', desc: 'Para los amantes del sabor' },
  ...
  { id: 13, name: 'Guiso de Garbanzos', price: 3700, category: 'platos', image: '/garbanzos.jpg', desc: 'Casero y contundente' },
  { id: 14, name: 'Tortilla Clásica', price: 2200, category: 'platos', image: '/tortilla.jpg', desc: 'Receta de la nona' },
  { id: 15, name: 'Buñuelos Caseros', price: 1800, category: 'platos', image: '/bunuelos.jpg', desc: 'Crujientes y dorados' },
  
  // --- DULCES ---
  { id: 16, name: 'Dulce de Membrillo', price: 2900, category: 'dulces', image: '/membrillo.jpg', desc: 'Tradicional casero' },
];
...
export default function Tienda() {
  ...
  return (
    <main className="min-h-screen pb-24">
      {/* NAVBAR CON LOGO NARANJA GRANDE */}
      ...
      <div className="max-w-7xl mx-auto px-4 pt-24">
        ...
        {/* FILTROS (Agregado "Dulces") */}
        <div className="flex flex-wrap justify-center gap-2 mb-8">
          {['todos', 'mermeladas', 'postres', 'conservas', 'platos', 'dulces'].map(c => (
            <button
              key={c}
