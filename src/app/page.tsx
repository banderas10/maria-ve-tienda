...
const productos = [
  ...
  { id: 13, nombre: 'Dulce de Leche Tradicional', precio: 9.50, imagen: '/products-maria/dulce- leche.jpg?v=2', descripcion: 'Elaborado a fuego lento con receta antigua.', categoria: 'Dulces', badge: 'Tradicional', rating: 5.0, reviews: 89 }
];
